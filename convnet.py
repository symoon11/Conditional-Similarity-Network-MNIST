...
class ConvNet(object):
    ...
    def __init__(self,
        ...
        self.W_conv2 = create_weight_variables([conv1_kernel_size, conv2_kernel_size, conv1_output, conv2_output], seed=seed, name="W_conv2")
    ...
    def create_convnet(self, data, feature="color", training=True):
